...
$total_rows             = HRP_Helper::get_data_count( HRP_Helper::get_announcements_row_count() );
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-inner">
				...
				<div class="nk-block-between g-3">
					<div class="nk-block-head-content">
						...
						<div class="nk-block-des text-soft">
							...
							<p> <?php printf( esc_html__( 'Have Total %s announcements', 'hrp' ), esc_html( $total_rows ) ); ?></p>
						</div>
					</div>
					<div class="nk-block-head-content">
						<ul class="nk-block-tools g-3">
							<li>
								<div class="dropdown">
									<a href="<?php echo esc_url( $announcements_page_url . '&action=save' ); ?>" class="btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
								</div>
							</li>
						</ul>
					</div>
			...
			<table class="nk-tb-list nk-tb-ulist is-compact" id="announcements">
				<thead>
					<tr class="nk-tb-item nk-tb-head">
						...
						<th class="nk-tb-col "><span class="sub-text"><?php esc_html_e( 'Type', 'hrp' ); ?></span></th>
